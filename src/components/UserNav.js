...
export default function UserNav() {
    ...
    return (
        ...
        <div className="fixed flex flex-col top-0 left-0 h-full p-8">
            <div className="flex items-center text-center pl-6 h-20">
                ...
                <ul>
                    ...
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                            ...
                            <span class="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Litters</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        {/* <div class="min-h-screen flex flex-col flex-auto bg-mint antialiased text-blkgray">
            <div class="fixed flex flex-col top-0 left-0 bg-mint h-full">
                <div class="flex items-center pl-6 h-20 border-b border-gray-800">
                    <img src={user.picture} alt="User profile image" class="rounded-full h-10 w-10 flex items-center justify-center mr-3 border-2 border-blkgray"/>
                    <div class="ml-1">
                        <p class="ml-1 text-md font-medium tracking-wide truncate text-blkgray">{user.name}</p>
                    </div>
                </div>
                ...
                <ul class="flex flex-col py-6 space-y-1">
                    <li class="px-5">
                        <div class="flex flex-row items-center h-8">
                            <div class="flex font-semibold text-sm my-4 uppercase">Dashboard</div>
                        </div>
                    </li>
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                    ...
                    <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-blue-500 pr-6">
                            ...
                            <span class="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Kittens</span>
                        </a>
                    </li>
                    <li class="px-5">
                    <div class="flex flex-row items-center h-8">
